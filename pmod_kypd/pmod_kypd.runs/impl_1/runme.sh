...
HD_PWD='/home/user/lab-3-5/pmod_kypd/pmod_kypd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log kypd_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source kypd_design_wrapper.tcl -notrace
