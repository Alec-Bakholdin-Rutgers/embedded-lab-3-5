...
HD_PWD='/home/user/lab-3-5/pmod_kypd/pmod_kypd.runs/kypd_design_PmodKYPD_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kypd_design_PmodKYPD_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kypd_design_PmodKYPD_0_0.tcl
