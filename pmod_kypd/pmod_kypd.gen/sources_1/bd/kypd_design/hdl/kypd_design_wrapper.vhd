...
--Command     : generate_target kypd_design_wrapper.bd
--Design      : kypd_design_wrapper
...
end kypd_design_wrapper;

architecture STRUCTURE of kypd_design_wrapper is
  component kypd_design is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
...
kypd_design_i: component kypd_design
     port map (
